...
unikraft run --metro fra \
  ...
  --image <my-org>/httpserver-node26-distroless:latest
```
...
* `FROM gcr.io/distroless/nodejs26-debian13:nonroot`: Use the Google Distroless Node.js 26 Debian 13 environment.
